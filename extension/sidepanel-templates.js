...
function spTemplateLicenseGate() {
  return '<div class="sp-license-gate">' +
    '<img class="sp-login-logo" src="/icons/logo.png" alt="' + ((window.tsBrandName && window.tsBrandName()) || 'Rise Lovable') + '">' +
    '<p class="sp-gate-title">Insira sua licença</p>' +
    '<p class="sp-gate-desc">Insira sua licença</p>' +
    '<input class="sp-input" id="sp-license-input" placeholder="LVBL-XXXX-XXXX-XXXX" spellcheck="false">' +
    '<button class="sp-btn-primary" id="sp-validate-btn">Validar Licença</button>' +

    '<div class="sp-gate-actions">' +
      '<a class="sp-btn-buy" href="https://riselovable.lovable.app/#plans" target="_blank" rel="noopener noreferrer"><span aria-hidden="true">&#128722;</span> Comprar Licença</a>' +
    '</div>' +
