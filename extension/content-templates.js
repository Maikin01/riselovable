...
function templateLicenseGate(minimized) {
  return '<div id="ql-header">' +
    '<div class="ql-header-left">' +
      ...
      '<span class="ql-title" data-ts-brand="name">' + ((window.tsBrandName && window.tsBrandName()) || 'Fennix Store') + '</span>' +
    '</div>' +
  ...
  '<div id="ql-body">' +
    '<div class="ql-license-gate">' +
      ...
      '<div class="ql-field">' +
        '<input id="ql-license-input" placeholder="QUALQUER-COISA-LIFETIME" spellcheck="false">' +
      '</div>' +
      '<button id="ql-validate-btn">Validar Licen\u00e7a</button>' +
      '<div id="ql-license-log"></div>' +
      '<div class="ql-gate-divider"><span data-ts-brand="name">' + ((window.tsBrandName && window.tsBrandName()) || 'Fennix Store') + '</span></div>' +  
    '</div>' +
  '</div>' +
...
function templateMainUI(greeting, statusBadge, minimized) {
  return '<div id="ql-header">' +
    '<div class="ql-header-left">' +
      '<span class="ql-brand" data-ts-brand="name">' + ((window.tsBrandName && window.tsBrandName()) || 'Fennix Store') + '</span>' +
  ...
  '<div id="ql-footer" class="ql-footer">' +
    ...
    '</div>' +
    '<span class="ql-badge-mz" data-ts-brand="footer"><span style="vertical-align:middle;display:inline-flex">' + SVG_ICONS.zap + '</span> Desenvolvido por ' + ((window.tsBrandName && window.tsBrandName()) || 'Fennix Store') + '</span>' +
  '</div>' +
  '<div id="ql-resize-handle" class="ql-resize-handle"></div>' +
  '<!-- Notifications Panel -->' +
